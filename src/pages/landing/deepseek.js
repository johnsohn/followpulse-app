    ...
    <div className="w-full min-h-screen bg-zinc-900 flex flex-col md:flex-row">
      ...
      <div className="md:w-1/2 md:flex md:flex-col md:items-center md:justify-between md:p-12">
        <div className="md:max-w-2xl md:max-h-[80vh] md:flex md:items-center md:justify-center">
          <img
            src={`/assets/funnel-screen-${stage + 1}${stage==0?"-deepseek":""}.png`}
        ...
        <div className="md:max-w-md md:mx-auto">
          {stage == 0 && (
            <div className="flex flex-col h-full md:h-auto">
              <h1 className="font-bold text-white md:text-black text-4xl text-center mt-6 mb-6">Get unlimited access to DeepSeek</h1>
              <span className="text-white md:text-black text-xl">Welcome to Chatbot App.</span>
              <span className="text-white md:text-black text-xl">Enjoy unlimited access to DeepSeek models.</span>
          ...
          <div className={`${stage != 1 && "hidden"} flex flex-col h-full md:h-auto`}>
            ...
            <span className="text-zinc-200 md:text-black text-xl">DeepSeek is capable of responding to any of your questions or needs. Just ask.</span>
          </div>
          ...
          <div className={`${stage != 2 && "hidden"} flex flex-col h-full md:h-auto`}>
            ...
            <span className="text-zinc-200 md:text-black text-xl">DeepSeek seemlessy integrated with Whatsapp, on your fingertips wherever and whenever.</span>
          </div>
